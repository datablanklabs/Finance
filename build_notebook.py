...
code(
    ...
    "# what was checked against the live service).",
...
md(
    ...
    "price; it's seven separate yes/no markets, one per strike, each quoting",
    "`P(CPI change > strike)`. The chart below plots that ladder directly --",
    "yes price against strike -- at four points in one full synthetic CPI",
    "cycle's life, from 30 days out to the close, with the same confidence",
...
md(
    ...
    "the synthetic `cpi` stand-in day by day and plots the confidence path",
...
code(
    "hist_dates = panel.dates[-KALSHI_EVENT_WINDOW_BARS:]",
    "hist = pd.DataFrame({",
