"""Build trader.ipynb without nbformat installed."""
...
code(
    ...
    "import warnings",
    "",
    "PROJECT_ROOT = pathlib.Path('/Volumes/Expansion/Documents/notebooks/AI-trader')",
    "",
    ...
    "    MultiFactorCrossSectional, OpenBBRepository, PairsTrading,",
...
md(
    "---",
    "## 4. Why execution timing is not a detail",
    "",
...
md(
    "---",
    "## 7. Parameter sweeps and the multiple-testing problem",
    "",
...
md(
    ...
    "",
    "**Point-in-time data.** The panel holds today's adjusted prices. Real",
    "fundamentals get restated, index membership changes, and tickers get reused. If",
    "you extend beyond price-only signals, implement a point-in-time store as an",
    "OpenBB provider — then the repository swap in section 1 buys you correctness,",
...
_out = __import__("pathlib").Path(__file__).resolve().parent / "trader.ipynb"
with open(_out, "w") as fh:
    json.dump(nb, fh, indent=1)

print(f"wrote trader.ipynb with {len(cells)} cells "
