"""Validate FundamentalsValueFilter and MacroRegimeFilter."""

import numpy as np
import pandas as pd

from qbt import (
    Backtester, CrossSectionalMomentum, EqualWeightBuyHold, FundamentalsPanel,
    FundamentalsValueFilter, MacroRegimeFilter, MacrosPanel, SyntheticRepository,
)
